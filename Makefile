...
# Generated by qmake (2.01a) (Qt 4.7.4) on: ?? ?? 6 16:43:49 2017
# Project:  ECU-RS-PC.pro
# Template: app
# Command: c:\qtsdk\desktop\qt\4.7.4\mingw\bin\qmake.exe -spec c:\QtSDK\Desktop\Qt\4.7.4\mingw\mkspecs\win32-g++ CONFIG+=release -o Makefile ECU-RS-PC.pro
#############################################################################
...
Makefile: ECU-RS-PC.pro  c:/QtSDK/Desktop/Qt/4.7.4/mingw/mkspecs/win32-g++/qmake.conf c:/QtSDK/Desktop/Qt/4.7.4/mingw/mkspecs/qconfig.pri \
	...
	$(QMAKE) -spec c:\QtSDK\Desktop\Qt\4.7.4\mingw\mkspecs\win32-g++ CONFIG+=release -o Makefile ECU-RS-PC.pro
